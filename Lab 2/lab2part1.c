...
const char *dataFilePath = "lab2part1data.txt";
FILE *dataFile;
int newFileFlag = 1;
...
int main(){
	...
	//
	// Use the polling I/O techinque to implement one RPi-to-DHT11 transaction
	// Verify the transaction output using its checksum data
	// Return the temperature and humidity output, print on screen and save it in a file
	//
